...
if sys.argv[1].isdigit() == True and sys.argv[2].isdigit() == True:
	...
	if 0 <= number1 < 1000 and 0 <= number2 < 1000:
		...
		print('As variáveis não atendem aos requisitos (pelo menos um valor maior que 1000)!')
else:
